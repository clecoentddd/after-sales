 ...
 * @param {string} quoteId - The ID of the approved quote linked to this job.
 ...
 */
export const JobCreatedEvent = (jobId, customerId, requestId, quoteId, jobDetails, status = 'Pending') => ({

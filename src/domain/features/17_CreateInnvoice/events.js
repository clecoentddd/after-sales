 ...
 * @param {string} quoteId - The ID of the quote related to the invoice.
 ...
 */
export const InvoiceCreatedEvent = (invoiceId, jobId, quoteId, customerId, amount, currency, description) => ({

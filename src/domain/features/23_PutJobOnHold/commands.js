 ...
 * This command is used to change the status of a pending job to "On Hold".
 ...
 */
export const PutJobOnHoldCommand = (jobId, heldByUserId, reason) => ({
  type: 'PutJobOnHold', // Command type identifier
  jobId,
  heldByUserId,
  reason,
});

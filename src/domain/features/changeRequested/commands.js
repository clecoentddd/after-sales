...
/**
 * Factory function for creating a RaiseChangeRequestCommand.
 ...
 * @returns {object} The RaiseChangeRequestCommand object.
 */
export const RaiseChangeRequestCommand = (requestId, changedByUserId, description) => ({
  type: 'RaiseChangeRequest', // Command type identifier
  requestId,
  changedByUserId,
  description,
});